2-step client flow using scoped variables instead of vault.
...
Link 2 uses var.token in the request body — no vault, no cleanup.
...
Compare with ClientFlowTransform which uses vault for the same pattern.
