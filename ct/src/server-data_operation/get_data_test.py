...
def test_002_i_want_to_get_speficic_internal_data_on_admin_interface(h2ac_admin, h2ac_traffic, admin_provision):
  ...
  responseBodyRef = {'method': 'GET', 'requests': [{'previousState': 'initial', 'receptionTimestampMs': 1623552779114, 'responseBody': {'foo': 'bar-2'}, 'responseDelayMs': 0, 'responseHeaders': {'content-type': 'text/html', 'x-version': '1.0.0'}, 'responseStatusCode': 200, 'serverSequence': 35, 'state': 'initial'}], 'uri': '/app/v1/foo/bar/2'}
