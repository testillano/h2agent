...
@pytest.mark.admin
def test_001_i_want_to_identify_wrong_schema_for_server_matching_operation_on_admin_interface(resources, h2ac_admin):
...
@pytest.mark.admin
def test_002_i_want_to_identify_wrong_content_for_server_matching_operation_on_admin_interface(resources, h2ac_admin):
...
@pytest.mark.admin
def test_003_i_want_to_send_valid_server_matching_operations_on_admin_interface(resources, h2ac_admin):
