...
@pytest.mark.admin
def test_001_i_want_to_identify_valid_server_matching_operation(resources, h2ac):
...
@pytest.mark.admin
def test_002_i_want_to_identify_wrong_schema_for_server_matching_operation(resources, h2ac):
...
@pytest.mark.admin
def test_003_i_want_to_identify_wrong_content_for_server_matching_operation(resources, h2ac):
