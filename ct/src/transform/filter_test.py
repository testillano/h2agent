...
@pytest.mark.transform
@pytest.mark.filter
def test_004_multiply(resources, h2ac_admin, h2ac_traffic):
...
@pytest.mark.transform
@pytest.mark.filter
def test_005_sum(resources, h2ac_admin, h2ac_traffic):
...
@pytest.mark.transform
@pytest.mark.filter
def test_006_regexcapture(resources, h2ac_admin, h2ac_traffic):
...
@pytest.mark.transform
@pytest.mark.filter
def test_007_regexcapturemultiple(resources, h2ac_admin, h2ac_traffic):
...
@pytest.mark.transform
@pytest.mark.filter
def test_008_regexreplace(resources, h2ac_admin, h2ac_traffic):
