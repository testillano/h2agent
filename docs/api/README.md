...
REST API documentation for h2agent.
...
| `guide.md` | User guide — conceptual docs for matching, FSM, transformations, triggering, data querying |
...
The script uses `curl --http2-prior-knowledge` (h2agent is HTTP/2 only).
